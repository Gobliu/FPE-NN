...
B_g1 = np.load('/home/liuwei/GitHub/FPE-Net-Results/Bessel/id10_11_p10_win1313/gg_iter0_smooth.npy')
B_h1 = np.load('/home/liuwei/GitHub/FPE-Net-Results/Bessel/id10_11_p10_win1313/hh_iter0_smooth.npy')
B_g2 = np.load('/home/liuwei/GitHub/FPE-Net-Results/Bessel/id10_11_p10_win1313/gg_iter36_smooth.npy')
B_h2 = np.load('/home/liuwei/GitHub/FPE-Net-Results/Bessel/id10_11_p10_win1313/hh_iter36_smooth.npy')
...
plt.plot(x2[18:88], B_real_g[18:88], 'k-', linewidth=3, label='True')
plt.scatter(x2[18:88], B_g1[18:88], c='b', marker='+', s=50, label='FPE NN')
plt.scatter(x2[18:88], B_g2[18:88], c='r', marker='d', s=50, label='FPE NN')
plt.tick_params(direction='in', width=3, length=6)
...
plt.plot(x2[18:87], B_real_h[18:87], 'k-', linewidth=3, label='True')
plt.scatter(x2[18:87], B_h1[18:87], c='b', marker='+', s=50, label='FPE NN')
plt.scatter(x2[18:87], B_h2[18:87], c='r', marker='d', s=50, label='LLS')
plt.tick_params(direction='in', width=3, length=6)
plt.xticks(np.arange(0.10, 1.11, 0.5), fontweight='bold')
plt.yticks(fontweight='bold')
