...
def main(run_id, p_patience, f_type, smooth_gh=0.1, smooth_p=False, sample_range=None, ):
    ...
    while run_ < 100:
        if f_type == 'Boltz':
            directory = '/home/liuwei/GitHub/Result/Boltz/id{}_p{}_win{}{}_{}'.format(run_id, p_patience, recur_win_gh,
                                                                                      recur_win_p, run_)
            data = np.load('./Pxt/Boltz_id{}_{}_sigma{}_200.npz'.format(run_id, seed, sigma))
        elif f_type == 'Bessel':
            directory = '/home/liuwei/GitHub/Result/Bessel/id{}_p{}_win{}{}_{}'.format(run_id, p_patience, recur_win_gh,
                                                                                       recur_win_p, run_)
            data = np.load('./Pxt/Bessel_id{}_{}_sigma{}_200.npz'.format(run_id, seed, sigma))
        elif f_type == 'OU':
    ...
    # gg_v = np.load('/home/liuwei/Cluster/Boltz/id1_p10_win99_0/iter279_gg_ng.npy')
    # hh_v = np.load('/home/liuwei/Cluster/Boltz/id1_p10_win99_0/iter279_hh_ng.npy')
